...
class User(AbstractUser):
    ...
    user_permissions = models.ManyToManyField(
        Permission, related_name='books_users')
...
class Book(models.Model):
    ...
    id_Author = models.ForeignKey(
        Author, to_field='id_Author', on_delete=models.CASCADE, blank=True, null=True)
    id_Genre = models.ForeignKey(
        Genre, to_field='id_Genre', on_delete=models.CASCADE, blank=True, null=True)
    ...
    id_Editorial = models.ForeignKey(
        Editorial, to_field='id_Editorial', on_delete=models.CASCADE, blank=True, null=True)
...
class Order(models.Model):
    ...
    id_Order_Status = models.ForeignKey(
        OrderStatus, to_field='id_Order_Status', on_delete=models.CASCADE)
