...
class BookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Book
        fields = ['id_Book', 'title', 'id_Author', 'id_Genre',
                  'id_Editorial', 'description', 'price', 'stock']
    ...
    def create(self, validated_data):
        ...
        existing_book = Book.objects.filter(
            title=validated_data['title']).first()
        if existing_book:
