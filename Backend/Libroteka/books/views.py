...
from .models import Author, Editorial, Genre, User, Book
from .serializer import AuthorSerializer, EditorialSerializer, GenreSerializer, UserSerializer, RegisterSerializer, BookSerializer
